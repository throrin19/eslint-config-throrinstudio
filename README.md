...
```bash
npm install -DE eslint babel-eslint eslint-plugin-html eslint-plugin-import eslint-multiple-parsers vue-eslint-parser eslint-plugin-vue eslint-config-throrinstudio
